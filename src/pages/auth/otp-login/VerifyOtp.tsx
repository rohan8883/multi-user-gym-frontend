...
import { ButtonLoading, FormProviders, OTPInput } from '@/components/forms';
...
export default function VerifyOTP({ data, setData, prev }: Readonly<IProps>) {
